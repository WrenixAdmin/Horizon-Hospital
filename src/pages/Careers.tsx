      ...
      <div className="min-h-screen bg-background">
        ...
        <main>
          <section className="relative h-56 overflow-hidden">
            <img
              src="https://static.vecteezy.com/system/resources/thumbnails/038/025/746/small/ai-generated-hospital-bed-in-a-hospital-room-empty-hospital-corridor-blurred-interior-of-the-hospital-abstract-medical-institution-photo.jpg"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-secondary/60 flex items-center">
              <div className="container mx-auto px-4">
                ...
                <p className="text-lg text-white/90">
                  Explore current openings and join our dedicated team of
                        ...
                        <Dialog>
                          ...
                          <DialogContent>
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Please fill the form below. After submitting
                                we'll open WhatsApp with a prefilled message —
                                you'll need to attach your CV manually when
                                WhatsApp opens.
                              </DialogDescription>
                            </DialogHeader>
                            ...
                            <DialogFooter className="mt-4">
                              <Button
                                variant="ghost"
                                onClick={() => {
                                  /* dialog close handled by Radix close button in dialog component */
                                }}
                              >
                                Close
                              </Button>
...
function ApplicationForm({ jobTitle }: { jobTitle: string }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (fileName) {
      lines.push(
        `Selected CV: ${fileName} (please attach this file manually in WhatsApp)`
      );
    } else {
    ...
    <form onSubmit={handleSubmit} className="space-y-4 mt-4">
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="A short intro or cover note (optional)"
          rows={4}
        />
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-muted-foreground mb-1">
          Attach CV (you will still need to attach it manually in WhatsApp)
        </label>
